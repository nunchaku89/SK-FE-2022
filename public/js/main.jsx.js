...
var app = React.createElement("div", {
  ...
  className: "contents",
  lang: "en"
}, React.createElement("h1", null, appState.headline), React.createElement("p", null, appState.description), React.createElement("form", {
  hidden: true
  ...
  "data-required": true
})), React.createElement("hr", null), React.createElement("footer", null, React.createElement("small", null, "COPYRIGHT ALL RESERVED. \xA9 ", getCurrentYear(), " by EUID"))), React.createElement("button", {
