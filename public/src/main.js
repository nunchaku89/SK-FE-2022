...
// 구조 분해 할당(dustructuring assignment) + 별칭(alias)
const { createElement: h } = React;

// 가상 DOM 요소 노드 : div#app
// React API : React.createElement(type[, props], ...children)

// Contents 가상 노드
const contentsVNode = h('div', {
  className: 'contents',
  lang: 'en',
  children: [
    h('h1', null, 'Imperative Programming'),
    h(
      'p',
      null,
...
// Translation Button 가상 노드
const translateButtonVNode = h('button', {
  type: 'button',
